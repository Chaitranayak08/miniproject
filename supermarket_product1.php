...
<div class="clothing-shops">
    ...
    <div class="clothing-shop1">
        <center>
      <img src="https://images.pexels.com/photos/196643/pexels-photo-196643.jpeg?auto=compress&cs=tinysrgb&w=400" alt="error"></center>
      <h3>Tomato</h3> 
      <p class="price">	&#8377; 40</p>
        <p>1KG tomato</p>
...
<form action ="manage_cart.php" method="POST">
    <div class="clothing-shop1">
        <center>
      <img src="https://images.pexels.com/photos/1306559/pexels-photo-1306559.jpeg?auto=compress&cs=tinysrgb&w=400" alt="error"></center>
      <h3>Carrot</h3> 
      <p class="price">&#8377; 35</p>
        <p>1KG carrot</p>
        <center><p><button type="submit" name="Add_to_Cart">Add to Cart</button></p></center>
...
<form action ="manage_cart.php" method="POST">
    <div class="clothing-shop1">
      <center><img src="https://images.pexels.com/photos/594137/pexels-photo-594137.jpeg?auto=compress&cs=tinysrgb&w=400" alt="error">
      </center>
      <h3>Capsicum</h3> 
      <p class="price">&#8377; 50</p>
        <p>1KG Capsicum-yellow</p>
        <center><p><button type="submit" name="Add_to_Cart">Add to Cart</button></p></center>
...
<form action ="manage_cart.php" method="POST">
    <div class="clothing-shop1">
     <center>
      <img src="https://images.pexels.com/photos/4207652/pexels-photo-4207652.jpeg?auto=compress&cs=tinysrgb&w=400" alt="error"></center>
      <h3>Eggs</h3> 
      <p class="price">&#8377; 70</p>
        <p>1 dozen eggs</p>
        <center><p><button type="submit" name="Add_to_Cart">Add to Cart</button></p></center>
...
<form action ="manage_cart.php" method="POST">
    <div class="clothing-shop1">
     <center>
      <img src="https://images.pexels.com/photos/3688/food-dinner-lunch-chicken.jpg?auto=compress&cs=tinysrgb&w=400" alt="error"></center>
      <h3>Chicken meat</h3> 
      <p class="price">&#8377;150 </p>
        <p>1KG chicken meat</p>
        <center><p><button type="submit" name="Add_to_Cart">Add to Cart</button></p></center>
        <input type="hidden" name="item_name" value="Chicken meat">
...
<form action ="manage_cart.php" method="POST">
    <div class="clothing-shop1">
    <center>
      <img src="https://images.pexels.com/photos/618775/pexels-photo-618775.jpeg?auto=compress&cs=tinysrgb&w=400" alt="error">
      </center>
      <h3>Mutton meat</h3> 
      <p class="price">&#8377; 190</p>
        <p>1KG mutton meat</p>
        <center><p><button type="submit" name="Add_to_Cart">Add to Cart</button></p></center>
        <input type="hidden" name="item_name" value="Mutton meat">
...
<form action ="manage_cart.php" method="POST">
    <div class="clothing-shop1">
 <center>
      <img src="https://images.pexels.com/photos/236010/pexels-photo-236010.jpeg?auto=compress&cs=tinysrgb&w=400" alt="error">
      </center>
      <h3>Milk</h3> 
      <p class="price">&#8377; 60</p>
        <p>1LT low-fat milk</p>
        <center><p><button type="submit" name="Add_to_Cart">Add to Cart</button></p></center>
...
<form action ="manage_cart.php" method="POST">
    <div class="clothing-shop1">
    <center>
      <img src="https://images.pexels.com/photos/6805775/pexels-photo-6805775.jpeg?auto=compress&cs=tinysrgb&w=400" alt="error"></center>
      <h3>Paneer</h3> 
      <p class="price">&#8377; 80</p>
        <p>500gm Paneer </p>
        <center><p><button type="submit" name="Add_to_Cart">Add to Cart</button></p></center>
...
<form action ="manage_cart.php" method="POST">
    <div class="clothing-shop1">
     <center>
      <img src="https://images.pexels.com/photos/2262832/pexels-photo-2262832.jpeg?auto=compress&cs=tinysrgb&w=400" alt="error"></center>
      <h3>Coffee Powder </h3> 
      <p class="price">&#8377; 400</p>
        <p>1KG coffee powder</p>
        <center><p><button type="submit" name="Add_to_Cart">Add to Cart</button></p></center>
        <input type="hidden" name="item_name" value="Coffee Powder">
