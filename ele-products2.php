...
<div class="clothing-shops">
    ...
    <div class="clothing-shop1">
        <center>
      <img src="https://images.pexels.com/photos/9667337/pexels-photo-9667337.jpeg?auto=compress&cs=tinysrgb&w=600" alt="error"></center>
      <h3>Iphone 13</h3> 
      <p class="price">	&#8377; 90,500</p>
        ...
        <center><p><button type="submit" name="Add_to_Cart">Add to Cart</button></p></center>
          ...
          <input type="hidden" name="price" value="90500">
    ...
    <div class="clothing-shop1">
        <center>
      <img src="https://images.pexels.com/photos/4029369/pexels-photo-4029369.jpeg?auto=compress&cs=tinysrgb&w=600" alt="error"></center>
      <h3>Samsung S10</h3> 
      <p class="price">&#8377; 25,000</p>
        <p>Samsung S20-128GB</p>
        <center><p><button type="submit" name="Add_to_Cart">Add to Cart</button></p></center>
          <input type="hidden" name="item_name" value="Samsung S10">
...
<form action ="manage_cart.php" method="POST">
    <div class="clothing-shop1">
      <center><img src="https://images.pexels.com/photos/4700383/pexels-photo-4700383.jpeg?auto=compress&cs=tinysrgb&w=600" alt="error">
      </center>
      <h3>Whirlpool </h3> 
      <p class="price">&#8377; 65,000</p>
        <p>Whirlpool washing machine</p>
        <center><p><button type="submit" name="Add_to_Cart">Add to Cart</button></p></center>
          <input type="hidden" name="item_name" value="Whirlpool">
...
<form action ="manage_cart.php" method="POST">
    <div class="clothing-shop1">
     <center>
      <img src="https://images.pexels.com/photos/973402/pexels-photo-973402.jpeg?auto=compress&cs=tinysrgb&w=600" alt="error"></center>
      <h3>Philips</h3> 
      <p class="price">&#8377; 2,500</p>
        <p>Philips hair dryer</p>
        <center><p><button type="submit" name="Add_to_Cart">Add to Cart</button></p></center>
          <input type="hidden" name="item_name" value="Philips dryer">
...
<form action ="manage_cart.php" method="POST">
    <div class="clothing-shop1">
     <center>
      <img src="https://images.pexels.com/photos/4333610/pexels-photo-4333610.jpeg?auto=compress&cs=tinysrgb&w=600" alt="error"></center>
      <h3>Philips</h3> 
      <p class="price">&#8377; 2,990</p>
        <p>Philips hair culer</p>
        <center><p><button type="submit" name="Add_to_Cart">Add to Cart</button></p></center>
          <input type="hidden" name="item_name" value="Philips curler">
...
<form action ="manage_cart.php" method="POST">
    <div class="clothing-shop1">
    <center>
      <img src="https://images.pexels.com/photos/1682519/pexels-photo-1682519.jpeg?auto=compress&cs=tinysrgb&w=600" alt="error">
      </center>
      <h3>Sony</h3> 
...
<form action ="manage_cart.php" method="POST">
    <div class="clothing-shop1">
 <center>
      <img src="https://images.pexels.com/photos/10906757/pexels-photo-10906757.jpeg?auto=compress&cs=tinysrgb&w=600" alt="error">
      </center>
      <h3>Airpods</h3> 
      <p class="price">&#8377; 18,900</p>
        <p>Apple airpods-2rd Gen</p>
        <center><p><button type="submit" name="Add_to_Cart">Add to Cart</button></p></center>
          <input type="hidden" name="item_name" value="Airpods2">
...
<form action ="manage_cart.php" method="POST">
    <div class="clothing-shop1">
    <center>
      <img src="https://images.pexels.com/photos/1682821/pexels-photo-1682821.jpeg?auto=compress&cs=tinysrgb&w=600" alt="error"></center>
      <h3>BOAT</h3> 
...
<form action ="manage_cart.php" method="POST">
    <div class="clothing-shop1">
     <center>
      <img src="https://images.pexels.com/photos/6980658/pexels-photo-6980658.jpeg?auto=compress&cs=tinysrgb&w=600" alt="error"></center>
      <h3>Panasonic</h3> 
